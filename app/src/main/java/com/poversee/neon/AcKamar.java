...
public class AcKamar extends AppCompatActivity {

    public AcKamar acKamar = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ac_kamar);
        acKamar = this;
        // get message from pi
        getMsgFromPi();
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            try {
                                ...
                                Toast.makeText(acKamar, "io exception", Toast.LENGTH_LONG).show();
                            } catch (InterruptedException interuptedException) {
                                Toast.makeText(acKamar, "interuptedException", Toast.LENGTH_LONG).show();
                            }
                        }
                    }).start();
                } else {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            Connection conn = Connection.connect(opts);
                            conn.publish("trihatmaja.ctrl.req", "{\"point_number\":4,\"dimm_value\":\""+ finalProgress +"\"}");
                            conn.close();
                        } catch (IOException ioException) {
                            Toast.makeText(acKamar, "io exception", Toast.LENGTH_LONG).show();
                        } catch (InterruptedException interuptedException) {
