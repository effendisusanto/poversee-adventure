...
public class DetailInfoActivity extends AppCompatActivity {
    ...
    public DetailInfoActivity detailInfoActivity = null;
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            try {
                                ...
                                Toast.makeText(detailInfoActivity, "io exception", Toast.LENGTH_LONG).show();
                            } catch (InterruptedException interuptedException) {
                                Toast.makeText(detailInfoActivity, "interuptedException", Toast.LENGTH_LONG).show();
                            }
                        }
                    }).start();
                } else {
