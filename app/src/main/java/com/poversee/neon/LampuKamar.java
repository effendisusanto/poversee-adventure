...
public class LampuKamar extends AppCompatActivity {

    public LampuKamar lampuKamar = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lampu_kamar);
        lampuKamar = this;
        // get message from pi
        getMsgFromPi();
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            try {
                                ...
                                Toast.makeText(lampuKamar, "io exception", Toast.LENGTH_LONG).show();
                            } catch (InterruptedException interuptedException) {
                                Toast.makeText(lampuKamar, "interuptedException", Toast.LENGTH_LONG).show();
                            }
                        }
                    }).start();
                } else {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            Connection conn = Connection.connect(opts);
                            conn.publish("trihatmaja.ctrl.req", "{\"point_number\":1,\"dimm_value\":\""+ finalProgress +"\"}");
                            conn.close();
                        } catch (IOException ioException) {
                            Toast.makeText(lampuKamar, "io exception", Toast.LENGTH_LONG).show();
                        } catch (InterruptedException interuptedException) {
